...
<head>
    <meta charset="UTF-8">
    <title>Pemasukan - Catatan Keuangan</title>
...
<div class="container">
    ...
    <a href="export.php" class="btn btn-outline-success mb-3">Export Excel</a>
        ...
        <table class="table table-bordered table-hover bg-white">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id=<?= $row['id_pemasukan'] ?>" class="btn btn-sm btn-warning">Edit</a>
                        <a href="hapus.php?id=<?= $row['id_pemasukan'] ?>" class="btn btn-sm btn-danger"
